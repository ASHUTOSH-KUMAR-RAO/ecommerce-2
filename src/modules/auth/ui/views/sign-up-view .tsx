  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div
          className="absolute -top-40 -right-40 w-80 h-80 bg-purple-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse"
          style={{ animation: "blob 7s infinite" }}
        ></div>
        <div
          className="absolute -bottom-40 -left-40 w-80 h-80 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse"
          style={{ animation: "blob 7s infinite 2s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-orange-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse"
      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-5 min-h-screen">
                ...
                >
                  ...
                  <div className="text-center mb-8">
                    <h1 className="text-3xl lg:text-4xl font-bold text-gray-800 mb-4 leading-tight">
                      ...
                      Creators Building Their Future on Funroad!
                    </h1>
                      ...
                      <FormItem className="group">
                        ...
                        <FormDescription
                          className={cn(
                            ...
                            showPreview &&
                              "block bg-gradient-to-r from-purple-50 to-pink-50 p-3 rounded-lg border border-purple-200"
                          )}
                        >
                          🌟 Your store will be available at{" "}
                          <strong className="text-purple-700">
                            funroad.com/{username}
                          </strong>
                        </FormDescription>
                  ...
                  >
                    <span
                      className={`transition-all duration-300 ${register.isPending ? "opacity-0" : "opacity-100"}`}
                    >
                      Create My Account 🚀
                    </span>
                    {register.isPending && (
        ...
        <div className="lg:col-span-2 hidden lg:flex items-center justify-center p-8">
          <div className="relative">
            <div className="w-96 h-96 bg-gradient-to-br from-purple-400 via-pink-400 to-orange-400 rounded-3xl shadow-2xl overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-8">
                ...
                <p className="text-center text-lg opacity-90">
                  Join thousands of creators who are building amazing things
                  with FunRoad
                </p>
            ...
            ></div>
            <div
              className="absolute -bottom-4 -right-4 w-6 h-6 bg-green-400 rounded-full animate-bounce"
