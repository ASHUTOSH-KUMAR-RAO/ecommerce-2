...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "categorise".
 */
export interface Categorise {
  id: string;
  name: string;
  slug: string;
  color?: string | null;
  parent?: (string | null) | Categorise;
  subCategorise?: {
    docs?: (string | Categorise)[];
    hasNextPage?: boolean;
    totalDocs?: number;
  };
  updatedAt: string;
...
/**
 * You must verify your account before creating a products
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "categorise_select".
 */
export interface CategoriseSelect<T extends boolean = true> {
  name?: T;
  slug?: T;
  color?: T;
  parent?: T;
